...
(function() {
  ...
  BubbleChart = (function() {
    function BubbleChart(data) {
      ...
      this.force = null;
      this.circles = null;
      this.fill_color = d3.scale.ordinal().domain(["IN", "OUT"]).range(["#28b576", "#1aa99d"]);
      max_amount = d3.max(this.data, function(d) {
        return parseInt(d.total_amount);
      });
      this.radius_scale = d3.scale.pow().exponent(0.5).domain([0, max_amount]).range([1, 50]);
      this.create_nodes();
      this.create_vis();
    }
    ...
    BubbleChart.prototype.create_vis = function() {
      ...
      this.circles.enter().append("circle").attr("r", 0).attr("fill", (function(_this) {
        return function(d) {
          return _this.fill_color(d.type);
        };
      })(this)).attr("stroke-width", 2).attr("stroke", (function(_this) {
        return function(d) {
          return d3.rgb(_this.fill_color(d.type)).darker();
        };
    ...
    BubbleChart.prototype.show_details = function(data, i, element) {
      ...
      content = "<span class=\"name\">Titulo:</span><span class=\"value\"> " + data.name + "</span><br/>";
      content += "<span class=\"name\">Preço:</span><span class=\"value\"> € " + (addCommas(data.value)) + "</span><br/>";
      content += "<span class=\"name\">Tipo:</span><span class=\"value\"> " + data.org + "</span>";
  ...
  $(function() {
    ...
    return d3.csv("data/oogo.csv", render_vis);
  });
