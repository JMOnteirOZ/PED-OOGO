<?php
    ...
    $sql = $db->prepare("INSERT INTO `order` (orderTitle, orderDescription, categoryID, orderLocation, orderPrice, orderDateOpen, orderDateClose, orderState, userID) VALUES (?,?,?,?,?,?,?,?,?)");
    //FALTA FOTO !!!
    $sql->execute([$title, $description, $num_category, $location, $price, $dateOpen, $dateClose, $state, $id]);
