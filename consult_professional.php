                            ...
                            <?php
                                ...
                                foreach($rs as $row) {
                                    echo '<div class="blog-post">';
                                        echo '<h3 class="blog-post-title"><a href="single-post-1.html">'.$row['userName'].'</a></h3>';                        
                                        ...
                                        echo '<div class="blog-post-date">';
                                            echo '<div>';
                                                echo '<img src="'.$row['userPhoto'].'" class="userpic">';
                                            echo '</div>';
                                        echo '</div><br>';
                                        echo '<p>'.$row['proDescription'].'<p>';
                                        echo '<a class="btn btn-primary btn-xs" href="single-post-1.html">Requisitar Profissional</a>';
                                    echo '</div>';
                                }
                            ?>
