<?php
    ...
    if (!isset($_SESSION['uname'])) {
        echo header("location: consult_order.php"); 
    }
?>
<!DOCTYPE html>
<html lang="pt">
        ...
        <div class="site-wrapper content bg-grey">
            ...
            <section id ="blog" class="parallax-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="php/perform_order.php" class="performform" name="performform" id="performform" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <center>
                                       <label for="perform_pic">Fotografia</label>
                                        <input type="file" name="perform_pic" />
                                    </center>
