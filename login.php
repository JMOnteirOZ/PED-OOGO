        ...
        <div class="site-wrapper content">
            ...
            <section id ="blog" class="parallax-section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <form method="post" action="php/registo.php" class="signupform" name="signupform" id="signupform" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-half-offset">
                                        <input name="reg_contact" type="text" id="reg_contact" class="form-control rounded-border" placeholder="Contacto" required />
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-half-offset">
                                    </div>
                                    <center>
                                        <label for="reg_pic">Fotografia</label>
                                        <input type="file" name="reg_pic" />
                                    ...
                                    <div id="prodiv" style="display:none">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-half-offset">
                                        <label for="reg_file">Certificado</label>
